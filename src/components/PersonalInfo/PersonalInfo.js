      ...
      <div className={s.down}>
        <AutoAffix viewportOffsetTop={80} container={this}>
          <Panel className={s.noBorder}>
            <table className={s.personalInfo}>
              <tbody>
                <tr>
                  <td><div className={s.profilePicture} /></td>
                </tr>
                <tr>
                  <td><h4> Christos Paschalidis </h4></td>
                </tr>
                <tr>
                  <td><h6>
                    I don't love studying. <br />
                    I hate studying. <br />
                    I like learning. <br /> Learning is beautiful.
                  </h6></td>
                </tr>
                <tr>
                  <td><h6><i className="fa fa-fw fa-map-marker" />Berlin, DE | Patras, GR </h6>
                  </td>
                </tr>
                <tr>
                  <td><h6>
